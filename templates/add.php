   <nav class="nav">
    ...
    <form class="form form--add-lot container <?= $form_error; ?>"
     action="./add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
          ...
          <div class="form__item <?= $error_name; ?>"> <!-- form__item--invalid -->
    ...
    <?php endforeach; ?>
      ...
      <div class="form__item form__item--file">
        ...
        <!-- ниже почему-то не выводиться -->
        <?php if (isset($errors['img'])) {
            echo "<span class='form__error'>" . $errors['img'] . "</span>";
           } 
           ?>
        <!--  -->
      </div>
      ...
      <?php $error_rate = isset($errors['lot-rate']) ? "form__item--invalid" : "1"; ?>
        ...
        <div class="form__item form__item--small <?= $error_rate; ?>">
          ...
          <input id="lot-rate" type="text" name="lot-rate"
           placeholder="0" value="<?=getPostVal('lot-rate');?>">
